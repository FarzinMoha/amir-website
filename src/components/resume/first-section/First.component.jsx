    ...
    <ul className="resume-education">
      ...
      <li className="resume-education-items1">
        <div className="resume-education-item-left">
          ...
          <p className="resume-education-item-left-text3">
            Graduated in Computer engineering at this university for 4 years.
          </p>
        </div>
        <div className="resume-education-item-right">
      ...
      <li className="resume-education-items2">
        <div className="resume-education-item-right">
          ...
          <p className="resume-education-item-right-text2">Freelance</p>
          <p className="resume-education-item-right-text3">
            Built an ecommerce webapp to sell products online. Increased company
            sales. Developed a launch website in EC2 service on AWS and Boosted
            streaming sales.
          </p>
        </div>
        <div className="resume-education-item-left">
          <p className="resume-education-item-left-text1">2020-2022</p>
        </div>
      </li>
    </ul>
  );
